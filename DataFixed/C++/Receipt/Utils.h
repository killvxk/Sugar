...
inline size_t Similarity(const std::string &str1, const std::string &str2) {
...
inline float SimilarityRate(const std::string &str1, const std::string &str2) {
	return 1 - (float)Similarity(str1, str2) / std::max(str1.length(), str2.length());
}
